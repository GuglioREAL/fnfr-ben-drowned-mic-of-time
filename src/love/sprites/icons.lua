...
return graphics.newSprite(
    images.icons,
	{
		...
		{x = 600, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 25: Ben Anim 1
		{x = 750, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 26: Ben Anim 2
		{x = 900, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 27: Ben Anim 3
		{x = 450, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 28: Ben Anim 2
		{x = 0, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 29: Ben2 Anim 1
		{x = 150, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 30: Ben2 Anim 2
		{x = 300, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 31: Ben2 Anim 3
		{x = 450, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 32: Ben2 Anim 4
		{x = 600, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 33: Ben2 Losing
		{x = 1050, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 34: Ben3
		{x = 1200, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0} -- 35: Ben3 Losing
	},
	{
		...
		["ben"] = {start = 25, stop = 28, speed = 6, offsetX = 0, offsetY = 0},
		["ben2"] = {start = 29, stop = 32, speed = 10, offsetX = 0, offsetY = 0},
		["ben2 losing"] = {start = 33, stop = 33, speed = 0, offsetX = 0, offsetY = 0},
		["ben3"] = {start = 34, stop = 34, speed = 0, offsetX = 0, offsetY = 0},
		["ben3 losing"] = {start = 35, stop = 35, speed = 0, offsetX = 0, offsetY = 0}
