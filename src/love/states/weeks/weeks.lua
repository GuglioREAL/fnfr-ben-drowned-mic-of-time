...
return {
	...
	initUI = function(self)
		...
		sprites.leftArrowB = love.filesystem.load("sprites/ben/left-arrow.lua")
		sprites.downArrowB = love.filesystem.load("sprites/ben/down-arrow.lua")
		sprites.upArrowB = love.filesystem.load("sprites/ben/up-arrow.lua")
		sprites.rightArrowB = love.filesystem.load("sprites/ben/right-arrow.lua")
